...
cover: 'https://office-1256119282.file.myqcloud.com/2022/official-web/cdn/20220301/pc_bg_08.jpg'
top_img:
comments: false
---
...
`{% raw %}{% post_link 标签插件-Tag-Plugins %}{% endraw %}`

{% post_link 标签插件-Tag-Plugins %}

**Display custom text.**

`{% raw %}{% post_link 标签插件-Tag-Plugins 'Link to a post' %}{% endraw %}`

{% post_link 标签插件-Tag-Plugins 'Link to a post' %}

**Escape title.**

```
{% post_link 标签插件-Tag-Plugins 'How to use <b> tag in title' %}
```
...
```
{% post_link 标签插件-Tag-Plugins '<b>bold</b> custom title' false %}
```
